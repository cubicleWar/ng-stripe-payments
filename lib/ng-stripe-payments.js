angular.module('ngStripePayments', []);
...
angular.module('ngStripePayments').factory('_Format',['Cards', 'Common', '$filter', function(Cards, Common, $filter){
	...
	var _hasTextSelected = function($target) {
		...
		if (!document ? (ref = document.selection) !== null ? typeof ref.createRange === "function" ? ref.createRange().text : void 0 : void 0 : void 0) {
			return true;
		}
...
angular.module('ngStripePayments').factory('_Validate', ['Cards', 'Common', '$parse', function(Cards, Common, $parse){
	...
	_validators.cvc = function(cvc, ctrl, scope, attr){
		...
		if(!cvc || cvc.length === 0) return true;
